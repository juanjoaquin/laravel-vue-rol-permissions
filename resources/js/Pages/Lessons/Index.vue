            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <li class="flex justify-between gap-x-6 py-5" v-for="lesson in lessons.data">
                                ...
                                <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                                    <p class="text-md leading-6 text-gray-900">
                                        <Link class="py-2 px-4" :href="route('lessons.edit', lesson.id)"
                                            v-if="$page.props.user.permissions.includes('update lessons')">Editar
                                        </Link>

                                        <Link class="py-2 px-4 text-red-600" @click="deleteLesson(lesson.id)"
                    ...
                    <div class="flex justify-between mt-2">
                        ...
                        <div v-else></div>
                        <Link v-if="lessons.total > 0 && lessons.current_page < lessons.last_page"
